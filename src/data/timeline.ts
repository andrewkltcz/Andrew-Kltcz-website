...
export const professional: TimelineItem[] = [
  ...
  { id: "aleido-return", date: "Nov 2017 – Feb 2020", title: "Rejoined Aleido", org: "Project Coordinator & Technical Writer", icon: "Undo2", description: "Returned to Aleido to continue project coordination and technical writing.", tags: ["#projectmanagement", "#technicalwriting", "#teamlead"], links: companyLinks.aleido },
...
export const creative: TimelineItem[] = [
  ...
  { id: "guitar", date: "2007", title: "Guitar & First Band", icon: "Guitar", description: "Picked up guitar and joined a first band.", tags: ["#music", "#audioengineering"] },
  { id: "piano", date: "2008", title: "Piano & Songwriting", icon: "Piano", description: "Learned piano and began writing songs.", tags: ["#music", "#audioengineering"] },
  { id: "web-design", date: "2008", title: "Web Design", icon: "PanelsTopLeft", description: "Built an early website to publish creative work.", tags: ["#ux", "#graphicsdesign", "#webdesign"] },
  { id: "photo", date: "2009", title: "Photography & Videography", icon: "Camera", description: "Moved behind the lens into photography, editing and video production.", tags: ["#photography", "#videoproduction"] },
  { id: "hnd-guitar", date: "Aug 2012 – Aug 2013", title: "Heroes Never Die", org: "Guitarist & Vocals", icon: "Guitar", description: "Performed as guitarist and vocalist with Heroes Never Die.", tags: ["#music", "#audioengineering", "#socialmediamanagement"] },
  ...
  { id: "silent-homes", date: "Aug 2015 – Jun 2016", title: "Silent Homes", org: "Vocalist", icon: "Mic", description: "Performed as vocalist with Silent Homes.", tags: ["#music", "#socialmediamanagement", "#onlinemarketing"] },
  ...
  { id: "midnight", date: "Jan 2018 – Oct 2022", title: "Midnight in November", org: "Vocalist", icon: "Mic", description: "Performed as vocalist with Midnight in November.", tags: ["#music", "#graphicsdesign", "#videoproduction", "#photography", "#socialmediamanagement", "#onlinemarketing"] },
  { id: "youtube", date: "2019", title: "Andrew Kltcz YouTube Channel", org: "Photo & Video Tutorials", icon: "Youtube", description: "Created photo and video tutorials for other creators.", tags: ["#videoproduction", "#photography"], links: [{ label: "Watch Playlists", href: "https://www.youtube.com/@andewkltcz/playlists" }] },
  { id: "soulharbour", date: "Oct 2022", title: "Soulharbour", org: "Vocals", icon: "Mic", description: "Performed vocals with Soulharbour.", tags: ["#music", "#graphicsdesign", "#videoproduction", "#photography", "#socialmediamanagement", "#onlinemarketing", "#webdesign"], links: [{ label: "Visit Soulharbour", href: "https://soulharbour.net/" }] },
...
export const convergence: TimelineItem = {
  ...
  org: "Relocation",
  icon: "Plane",
  description: "A relocation to Swansea, UK connecting manufacturing, team leadership and project management experience.",
  tags: ["#manufacturing", "#teamlead", "#projectmanagement"],
};
