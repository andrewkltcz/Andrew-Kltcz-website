...
export const professional: TimelineItem[] = [
  ...
  { id: "aleido-return", date: "Nov 2017 – Feb 2020", title: "Rejoined Aleido as a Project Coordinator", org: "than Aleido, Budapest", icon: "Undo2", description: "Returned to Aleido to continue project coordination and technical writing.", tags: ["#projectmanagement", "#technicalwriting", "#teamlead"], links: companyLinks.aleido },
...
export const creative: TimelineItem[] = [
  ...
  { id: "hnd-guitar", date: "Aug 2012 – Aug 2013", title: "Vocals", org: "Heroes Never Die", icon: "Mic", description: "Performed vocals with Heroes Never Die.", tags: ["#music", "#audioengineering", "#socialmediamanagement"] },
  ...
  { id: "youtube", date: "2020", title: "Andrew Kltcz YouTube Channel", org: "Photo & Video Tutorials", icon: "Youtube", description: "Created photo and video tutorials for other creators.", tags: ["#videoproduction", "#photography"], links: [{ label: "Watch Playlists", href: "https://www.youtube.com/@andewkltcz/playlists" }] },
